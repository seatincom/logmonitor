...
<body>
    ...
    <div class="contents">
        <div class="results"><textarea id="results" style="margin: 0px;width: 100%;/* height: 274px; */bottom: 0;position: absolute;top: 52px;background: #000;color: #fff;"></textarea></div>
